...
interface AnimatedPigSnoutProps {
  className?: string;
  size?: number;
}

export const AnimatedPigSnout: React.FC<AnimatedPigSnoutProps> = ({
  className = "",
  size = 24,
}) => {
  return (
    ...
    >
      ...
      {/* Main pig snout shape - outline only */}
      <path
        fill="none"
      ...
      {/* Inner snout detail - outline only */}
      <path
        fill="none"
        stroke="url(#animatedGradient)"
        strokeWidth="1"
